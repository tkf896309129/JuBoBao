...
import static com.example.huoshangkou.jubowan.chat.helper.CustomMessage.JSON_VERSION_1_HELLOTIM;
...
//        inputLayout.addAction(videoCall);
    ...
    public static class CustomInputFragment extends BaseInputFragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
            View baseView = inflater.inflate(R.layout.chat_input_custom_fragment, container, false);
