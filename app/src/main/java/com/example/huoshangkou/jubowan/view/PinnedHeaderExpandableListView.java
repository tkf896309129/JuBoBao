 ...
 * 类名：PinnedHeaderExpandableListView
 * 描述：
...
public class PinnedHeaderExpandableListView extends ExpandableListView implements OnScrollListener, OnGroupClickListener {
    ...
    private static int mHeaderViewWidth;
    private static int mHeaderViewHeight;
...
//            parent.collapseGroup(groupPosition);
    ...
    public static int getmHeaderViewWidth() {
        return mHeaderViewWidth;
    }

    public static int getmHeaderViewHeight() {
        return mHeaderViewHeight;
    }

    public static View getmHeaderView() {
        return mHeaderView;
    }
}