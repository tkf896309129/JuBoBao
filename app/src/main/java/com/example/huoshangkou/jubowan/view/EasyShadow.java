 ...
 * @author fxyan
 */
public final class EasyShadow extends Drawable {
  ...
  public EasyShadow(int shape, int[] bgColor, int shapeRadius, int shadowColor,
  ...
  public void draw(@NonNull Canvas canvas) {
    ...
    if (mShape == SHAPE_ROUND) {
      ...
      canvas
          .drawCircle(mRect.centerX(), mRect.centerY(), Math.min(mRect.width(), mRect.height()) / 2,
              mShadowPaint);
      canvas
          .drawCircle(mRect.centerX(), mRect.centerY(), Math.min(mRect.width(), mRect.height()) / 2,
              mBgPaint);
  ...
  public static void setShadowDrawable(View view, int shapeRadius, int shadowColor,
      int shadowRadius, int offsetX, int offsetY) {
    EasyShadow drawable = new Builder()
  ...
  public static class Builder {
    ...
    public EasyShadow builder() {
      return new EasyShadow(mShape, mBgColor, mShapeRadius, mShadowColor, mShadowRadius,
          mOffsetX, mOffsetY);
    }
  }
}